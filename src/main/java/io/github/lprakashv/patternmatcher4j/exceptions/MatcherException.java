...
public class MatcherException extends Exception {
  ...
  private transient final Object matchedObject;

  public MatcherException(int index, Object matchedObject) {
    this.index = index;
    this.matchedObject = matchedObject;
  }

  public MatcherException(int index, Object matchedObject, String message) {
    super(message);
    this.index = index;
    this.matchedObject = matchedObject;
  }

  public MatcherException(int index, Object matchedObject, String message, Throwable cause) {
    super(message, cause);
    this.index = index;
    this.matchedObject = matchedObject;
  }

  public MatcherException(int index, Object matchedObject, Throwable cause) {
    super(cause);
    this.index = index;
    this.matchedObject = matchedObject;
  }
  ...
  public String getMessage() {
    ...
    if (this instanceof MatchException) {
      errorDetails.put("match_type",
          "\"" + ((MatchException) this).getMatch().getMatchType().name() + "\"");

      if (this instanceof DestructuredFieldExceptions) {
        Map<String, String> fieldErrors = new LinkedHashMap<>();
        for (FieldException fieldException : ((DestructuredFieldExceptions) this)
            .getFieldExceptions()) {
